...
namespace MES.API.Migrations
{
    ...
    [Migration("20260605191001_AddProductionTrackingV4")]
    partial class AddProductionTrackingV4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MES.API.Models.Defect", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DefectId = 1,
                            DefectCode = "DF001",
                            DefectName = "Missing Component"
                        },
                        new
                        {
                            DefectId = 2,
                            DefectCode = "DF002",
                            DefectName = "Wrong Part"
                        },
                        new
                        {
                            DefectId = 3,
                        ...
                        new
                        {
                            DefectId = 4,
                            DefectCode = "DF004",
                            DefectName = "Tombstone"
                        },
                        new
                        {
                            DefectId = 5,
                            DefectCode = "DF005",
                            DefectName = "Insufficient Solder"
                        });
                });
            ...
            modelBuilder.Entity("MES.API.Models.ProductionTracking", b =>
                {
                    b.Property<long>("ProductionTrackingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("ProductionTrackingId"));
            ...
            modelBuilder.Entity("MES.API.Models.ProductionTracking", b =>
                {
                    b.HasOne("MES.API.Models.Defect", "Defect")
                        .WithMany()
                        .HasForeignKey("DefectId");

                    b.HasOne("MES.API.Models.Machine", "Machine")
                        .WithMany()
                        .HasForeignKey("MachineId");

                    b.HasOne("MES.API.Models.User", "Operator")
                        .WithMany()
                        .HasForeignKey("OperatorId");

                    b.HasOne("MES.API.Models.SerialNumber", "SerialNumber")
                        .WithMany()
            ...
            modelBuilder.Entity("MES.API.Models.WorkOrder", b =>
                {
                    b.HasOne("MES.API.Models.User", "CreatedByUser")
                        .WithMany()
